            ...
            <div class="box">
               ...
               <div class="box-body">
                   <div class="table-responsive">
                    ...
                    <div class="form-group">
                        <h5>SubSubcategory Name French<span class="text-danger">*</span></h5>
                        <div class="controls">
                          <input type="text" name="subsubcategory_name_fr" 
                          class="form-control" value="{{$subsubcategories->subsubcategory_name_fr}}">
